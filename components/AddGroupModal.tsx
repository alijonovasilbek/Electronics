...
interface AddGroupModalProps {
  onClose: () => void;
  onAddGroup: (group: Omit<Group, 'id' | 'created_at'>) => void;
}
...
const AddGroupModal: React.FC<AddGroupModalProps> = ({ onClose, onAddGroup }) => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onAddGroup({ name, description, is_active });
  };
        ...
        <form onSubmit={handleSubmit}>
          <div className="p-8">
            ...
            <div className="space-y-4">
              ...
              <Select label="Status" value={String(is_active)} onChange={e => setIsActive(e.target.value === 'true')}>
