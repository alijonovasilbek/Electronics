                    ...
                    <div className="flex justify-between items-start mb-6">
                        <div className="flex flex-col sm:flex-row items-center text-center sm:text-left">
                            ...
                            <div>
                                ...
                                {/* FIX: Conditionally render coach name as it may be undefined for API-fetched groups. */}
                                <p className="text-lg text-gray-600">{group.name}{group.coach ? ` - ${group.coach}` : ''}</p>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="lg:col-span-1 space-y-6">
                           ...
                           <InfoCard title="Contract Details">
                                <InfoItem icon={<DocumentTextIcon/>} label="Start Date" value={studentContract?.contract_date || 'N/A'} />
                                <InfoItem icon={<DocumentTextIcon/>} label="End Date" value={studentContract?.expiry_date || 'N/A'} />
                                <a href="#" className="text-bunyodkor-blue font-semibold hover:underline mt-2 inline-block">View Contract</a>
                           </InfoCard>
                        </div>
